...
| 4.18 | Composer StatusDock pixel parity per Paper 9I-0: ContextPill, ModelPicker dock variant, PromptComposer slot refactor, kebab menu with Clear/Duplicate/Close, per-pane isolation, FolderPill, design-system playground. | M | 4.7, 4.16, 4.17 | review | TIN-199 · PR #119 · branch `khvni/tin-199`. |
