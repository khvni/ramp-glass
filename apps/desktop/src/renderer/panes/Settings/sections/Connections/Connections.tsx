...
export const Connections = ({
  ...
  return (
    <div className="tk-connections">
      {notice ? (
        <div
          className={`tk-connections__notice tk-connections__notice--${notice.kind}`}
      ...
      <div className="tinker-list">
        ...
        <article className="tinker-list-item">
          <div className="tk-connections__memory-row">
            <div className="tk-connections__memory-copy">
              <h3>Memory folder</h3>
              <p className="tinker-muted">
          ...
          <div className="tk-connections__path-shell">
            <p className="tk-connections__path-label">Current root</p>
            <p className="tk-connections__path-value" title={memoryRoot ?? 'Resolving memory folder…'}>
      ...
      {moveProgress ? (
        <div className="tk-connections__move-backdrop">
          <section
            className="tk-connections__move-dialog"
            role="dialog"
            aria-modal="true"
            aria-labelledby="memory-move-title"
          >
            ...
            <div
              className="tk-connections__progress"
              role="progressbar"
              aria-valuemin={0}
            ...
            >
              <div className="tk-connections__progress-value" style={{ width: `${progressPercent}%` }} />
            </div>
            <p className="tk-connections__move-meta">{progressPercent}% complete</p>
            {moveProgress.currentPath ? (
              <p className="tk-connections__move-current">Current file: {moveProgress.currentPath}</p>
            ) : null}
          </section>
        </div>
      ) : null}
